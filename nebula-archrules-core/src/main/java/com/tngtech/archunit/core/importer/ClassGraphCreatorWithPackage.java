...
import static com.tngtech.archunit.core.domain.DomainObjectCreationContextWithPackage.completePackage;
...
import static com.tngtech.archunit.thirdparty.com.google.common.collect.ImmutableSet.toImmutableSet;

/**
 * Copy of <a href="https://github.com/wakingrufus/ArchUnit/blob/main/archunit/src/main/java/com/tngtech/archunit/core/importer/ClassGraphCreator.java">ClassGraphCreator</a>
 * with changes from <a href="https://github.com/TNG/ArchUnit/pull/1565">package dependency scanning</a> applied
 */
public class ClassGraphCreatorWithPackage implements ImportContext {
    ...
    ClassGraphCreatorWithPackage(ClassFileImportRecord importRecord,
                                 DependencyResolutionProcessWithPackage dependencyResolutionProcess,
